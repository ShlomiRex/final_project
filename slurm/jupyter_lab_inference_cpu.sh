#!/bin/bash
#SBATCH --job-name=jupyter_lab_inference_cpu
#SBATCH --qos=normal           # Normal priority QoS for CPU jobs
#SBATCH --gres=gpu:0        # Request 0 GPU
...
#SBATCH --output=slurm/logs/jupyter_lab_inference_cpu_%j.out
#SBATCH --error=slurm/logs/jupyter_lab_inference_cpu_%j.err
...
#
# Usage:
#   sbatch slurm/jupyter_lab_inference_cpu.sh
#
# To connect from your local machine, check the output file:
#   cat slurm/logs/jupyter_lab_inference_cpu_<JOB_ID>.out
#
