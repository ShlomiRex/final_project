...
\begin{figure}[h]
    ...
    \caption[Iterative denoising process in diffusion models, from noise to image]{The iterative denoising process in diffusion models: starting from random noise, the model progressively refines the image through multiple steps.}
