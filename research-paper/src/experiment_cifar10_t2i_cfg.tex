...
\begin{figure}[H]
    ...
    \caption[Representative CIFAR-10 samples at $w=5$]{Representative generated CIFAR-10 images using guidance scale $w=5$. The figure showcases a diverse set of samples across all classes, illustrating the model's ability to generate class-conditional images with moderate prompt adherence and visual quality.}
    \label{fig:cifar10_samples_representative}
\end{figure}

\begin{table}[h]
    \centering
    \caption{CIFAR-10 Generation Metrics Across Guidance Scales. Accuracy$^\ast$ measures prompt adherence.}
