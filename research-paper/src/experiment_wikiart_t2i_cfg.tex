...
$w = 1.0$ (CLIP\,=\,0.2548, composite\,=\,0.468) and $w = 3.0$ (FID\,=\,259.1).  The dashed
...
styles; columns correspond to guidance scales $w \in \{0, 1, 2, 3, 5, 7.5, 10, 12.5, 15, 20\}$. Images remain visually consistent across $w \in [0, 10]$;
...
inference steps $T_{\text{inf}} \in \{1, 5, 10, 20, 50, 100, 200, 250, 300, 350\}$.}
