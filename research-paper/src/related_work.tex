...
Creative Adversarial Networks (CAN) extend the GAN framework specifically for artistic image generation \cite{elgammal2017can}. The Deep Interactive Evolution (DeepIE) approach combines CAN with evolutionary algorithms to enable user-guided art creation. This methodology, trained on the WikiArt dataset, allows users to interactively guide the generation process through iterative selection and refinement. For a recent implementation and extension of this approach, see \cite{yagil2023can}.
