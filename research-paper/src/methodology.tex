...
\begin{itemize}
    \item \textbf{Input/Output:} 1-channel grayscale images at 28$\times$28 resolution
...
\begin{itemize}
    \item \textbf{Resolution:} Limited to 28$\times$28 pixels due to MNIST dataset constraints
